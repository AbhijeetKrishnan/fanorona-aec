...
def parse_args():
    ...
    parser.add_argument(
        "--env_id", type=str, default="fanorona_v3", help="the id of the environment"
    )
    parser.add_argument(
        "--total_timesteps",
        type=int,
    ...
    parser.add_argument(
        "--num_minibatches", type=int, default=4, help="the number of mini-batches"
    )
    parser.add_argument(
        "--update_epochs", type=int, default=4, help="the K epochs to update the policy"
    )
    parser.add_argument(
        "--norm_adv", type=bool, default=True, help="Toggles advantages normalization"
    )
    parser.add_argument(
        "--clip_coef",
        type=float,
