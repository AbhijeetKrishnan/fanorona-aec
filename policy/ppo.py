...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="fanorona_v3",
...
if __name__ == "__main__":
    ...
    # env setup
    aec_env = fanorona_v3.env()
    print(aec_env.metadata)
    print(fanorona_aec.__file__)
    env = pettingzoo.utils.conversions.aec_to_parallel(aec_env)
